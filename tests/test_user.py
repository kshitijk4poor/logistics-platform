...
async def test_get_user_by_id_success():
    user = await create_user({"email": "fetch@example.com", "name": "Fetch User", "password": "securepassword"})
...
async def test_get_driver_by_id_success():
    driver = await create_driver({"email": "fetchdriver@example.com", "name": "Fetch Driver", "license_number": "D1234567"})
...
async def test_update_user_success():
    user = await create_user({"email": "update@example.com", "name": "Update User", "password": "securepassword"})
...
async def test_update_user_invalid_data():
    user = await create_user({"email": "updateinvalid@example.com", "name": "Update Invalid User", "password": "securepassword"})
...
async def test_update_driver_success():
    driver = await create_driver({"email": "updatedriver@example.com", "name": "Update Driver", "license_number": "D1234567"})
...
async def test_update_driver_invalid_data():
    driver = await create_driver({"email": "updateinvaliddriver@example.com", "name": "Update Invalid Driver", "license_number": "D1234567"})
